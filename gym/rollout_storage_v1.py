...
class RolloutStorage:
    ...
    def clear(self):
        ...
        self.action_probs= torch.zeros(self.num_transitions_per_env, self.num_envs, 54, device=self.device)
    ...
    def mini_batch_generator(self, num_mini_batches, num_learning_epochs):
        ...
        for epoch in range(num_learning_epochs):
            ...
            for start in range(0, batch_size, mini_batch_size):
                ...
                action_probs_batch = self.action_probs.view(-1, 54)[indices[start:start + mini_batch_size]]  # 确保形状匹配
