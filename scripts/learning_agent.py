...
class LearningAgent:
    def __init__(self, env, train_cfg, device="cuda" if torch.cuda.is_available() else "cpu", pretrained_model_path=None):
...
if __name__ == "__main__":
    ...
    env = RoboticArmEnv()
    pretrained_model_path = "./logs/model_checkpoint_500.pth"
    agent = LearningAgent(env, train_cfg, device="cuda" if torch.cuda.is_available() else "cpu",
